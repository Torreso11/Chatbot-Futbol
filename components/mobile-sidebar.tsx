...
export function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className="fixed inset-y-0 left-0 w-80 max-w-[85vw] bg-[#0A0A0A] border-r border-[#1F1F1F] z-50 lg:hidden flex flex-col animate-in slide-in-from-left duration-300">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[#1F1F1F]">
          ...
          <button onClick={onClose} className="p-2 rounded-lg text-[#A0A0A0] hover:text-white hover:bg-[#1A1A1A]">
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        {/* New Chat Button */}
        <div className="p-3">
          <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-[#1A3C34] to-[#2A5C4C] text-white font-medium text-sm">
